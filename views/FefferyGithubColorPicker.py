...
import callbacks.FefferyGithubColorPicker
            ...
            [
                ...
                fac.AntdBreadcrumb(
                    items=[
                        ...
                        {
                            'title': 'FefferyGithubColorPicker Github风格色彩选择器'
                        }
                    ]
                ),
                ...
                fac.AntdParagraph(
                    [
                        fac.AntdText('　　Github风格的16进制色彩选择器。')
                    ]
                ),
...
'''
        ...
        render_side_props_layout(
            component_name='FefferyGithubColorPicker'
        )
    ],
    style={
        'display': 'flex'
